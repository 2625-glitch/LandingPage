    ...
    <div>
      ...
      >
        <div className="text-center mt-16">
          ...
          <p className="text-4xl mb-6 text-white font-semibold">
        ...
        <div className="relative max-w-[780px] mx-auto flex justify-center items-center lg:top-[125px] top-[100px] p-3">
          <img
