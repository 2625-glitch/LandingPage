...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div className="md:px-28 px-4  max-w-screen-2xl mx-auto "  style={{backgroundColor:'#2B303B'}}>
      <div className="pt-20 pb-20 px-6 md:px-10 lg:px-16 flex flex-col lg:flex-row justify-start items-center">
    <div className="mb-6 lg:mb-0">
      <h1 className="text-white text-2xl lg:text-3xl font-bold mb-4">Dont miss the best management tool of the world</h1>
      <p className="text-white text-sm lg:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure nam, illum et quis officiis beatae.</p>
    </div>
    <div className="flex items-start lg:items-center" style={{ marginLeft: '14rem' }}>
      <Button size="large" variant="contained" className="text-black" style={{ backgroundColor: '#FF9103'  }}>
