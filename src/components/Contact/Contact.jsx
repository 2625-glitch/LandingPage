      ...
      <div className="md:px-28 px-6 py-16 max-w-screen-2xl mx-auto">
        ...
        <form noValidate autoComplete="off" onSubmit={handleSubmit}>
          <FormControl class="full-width space-y-8">
            ...
            <button
              type="submit"
              className="p-3 hover:bg-blue-700 text-white font-bold  rounded-full"
      ...
      >
        <div className="block h-full p-8 flex flex-col shadow-lg">
          ...
          <p className="text-sm font-light mb-4">
            ...
            adipisicing elit consectetur adipisicing elit. Officiis perferendis
            rem, aut aliquam.
          </p>
          <Button
            size="medium"
            style={{ backgroundColor: '#FE6D01' }}
            href="#text-buttons"
            variant="contained"
            className="w-32"
          >
